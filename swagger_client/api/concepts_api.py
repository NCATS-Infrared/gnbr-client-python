...
class ConceptsApi(object):
    ...
    def get_concept_details_with_http_info(self, concept_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='list[BeaconConceptWithDetails]',  # noqa: E501
    ...
    def get_concepts(self, keywords, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_concepts(keywords, async=True)
        >>> result = thread.get()
        ...
        :param str types: a (url-encoded) space-delimited set of semantic groups (specified as codes gene, pathway, etc.) to which to constrain concepts matched by the main keyword search (see [Biolink Model](https://biolink.github.io/biolink-model) for the full list of codes) 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_concepts_with_http_info(keywords, **kwargs)  # noqa: E501
        else:
            (data) = self.get_concepts_with_http_info(keywords, **kwargs)  # noqa: E501
            return data

    def get_concepts_with_http_info(self, keywords, **kwargs):  # noqa: E501
        """get_concepts  # noqa: E501

        Retrieves a (paged) list of whose concept in the  beacon knowledge base with names and/or synonyms  matching a set of keywords or substrings.  The (possibly paged) results returned should generally  be returned in order of the quality of the match,  that is, the highest ranked concepts should exactly  match the most keywords, in the same order as the  keywords were given. Lower quality hits with fewer  keyword matches or out-of-order keyword matches,  should be returned lower in the list.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_concepts_with_http_info(keywords, async=True)
        >>> result = thread.get()
        ...
        all_params = ['keywords', 'types', 'page_number', 'page_size']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('keywords' not in params or
            ...
            raise ValueError("Missing the required parameter `keywords` when calling `get_concepts`")  # noqa: E501
    ...
    def get_exact_matches_to_concept(self, concept_id, **kwargs):  # noqa: E501
        """get_exact_matches_to_concept  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_exact_matches_to_concept(concept_id, async=True)
        >>> result = thread.get()

        :param async bool
        :param str concept_id: (url-encoded) CURIE identifier of the concept to be matched (required)
        :return: list[str]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_exact_matches_to_concept_with_http_info(concept_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_exact_matches_to_concept_with_http_info(concept_id, **kwargs)  # noqa: E501
            return data

    def get_exact_matches_to_concept_with_http_info(self, concept_id, **kwargs):  # noqa: E501
        """get_exact_matches_to_concept  # noqa: E501

        Retrieves a list of qualified identifiers of \"exact match\" concepts, [sensa SKOS](http://www.w3.org/2004/02/skos/core#exactMatch) associated with a specified (url-encoded) CURIE (without brackets) concept object identifier,  typically, of a concept selected from the list of concepts originally returned by a /concepts API call on a given KS.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_exact_matches_to_concept_with_http_info(concept_id, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_exact_matches_to_concept" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'concept_id' is set
        if ('concept_id' not in params or
                params['concept_id'] is None):
            raise ValueError("Missing the required parameter `concept_id` when calling `get_exact_matches_to_concept`")  # noqa: E501
    ...
    def get_exact_matches_to_concept_list(self, c, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param list[str] c: set of [CURIE-encoded](https://www.w3.org/TR/curie/) identifiers of exactly matching concepts, to be used in a search for additional exactly matching concepts [*sensa*-SKOS](http://www.w3.org/2004/02/skos/core#exactMatch).  (required)
        :return: list[str]
                 If the method is called asynchronously,
                 returns the request thread.
        """
